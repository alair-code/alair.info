...
export const HeroSection: React.FC = () => {
  return (
    <section id="inicio" className="relative overflow-hidden bg-gradient-to-b from-surface-subtle via-surface-base to-surface-subtle pt-28 pb-16 sm:pt-32 lg:pt-40 lg:pb-24">
      ...
      <div className="ambient-light ambient-drift absolute -top-32 right-[-10rem] h-96 w-96 bg-brand-accent/10" aria-hidden="true" />
      <div className="ambient-light absolute bottom-0 left-[-12rem] h-80 w-80 bg-brand-navy/5" aria-hidden="true" />
      <div className="absolute left-1/2 top-20 -translate-x-1/2 h-72 w-[42rem] max-w-full rounded-full bg-brand-accent/5 blur-3xl pointer-events-none" aria-hidden="true" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            <div className="hero-enter inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-surface-base border border-border-light shadow-e1 text-xs font-semibold text-text-title mb-6" style={{ '--stagger': '80ms' } as React.CSSProperties}>
            ...
            <h1 className="hero-enter text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] font-extrabold text-brand-navy tracking-tight leading-[1.08] font-display mb-6" style={{ '--stagger': '160ms' } as React.CSSProperties}>
              Tecnologia que transforma sua presença digital em{' '}
              <span className="relative inline-block text-brand-navy">seu negócio.<svg className="hero-underline-draw absolute left-0 -bottom-2 w-full h-3 text-brand-accent/80 -z-10" viewBox="0 0 250 12" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M3 9C60 2.5 180 2.5 247 8.5" stroke="currentColor" strokeWidth="6" strokeLinecap="round" /></svg></span>
            </h1>

            <p className="hero-enter text-lg sm:text-xl text-text-body leading-relaxed max-w-2xl mb-8" style={{ '--stagger': '260ms' } as React.CSSProperties}>
            ...
            <div className="hero-enter w-full sm:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-3 mb-9" style={{ '--stagger': '360ms' } as React.CSSProperties}>
              <a href={getWhatsAppLink('Olá, Alair! Vim pelo site da Alair Informática e gostaria de conversar sobre um projeto.')} target="_blank" rel="noopener noreferrer" className="btn-premium btn-navy inline-flex items-center justify-center gap-3 px-7 py-4 rounded-xl bg-brand-navy hover:bg-brand-navy-light text-white text-base font-bold shadow-lg focus:outline-none focus:ring-4 focus:ring-brand-accent/40 group">
                <MessageSquare className="w-5 h-5 text-brand-accent" />
                <span>Falar comigo</span>
                <ArrowRight className="w-4 h-4 text-brand-accent group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="#servicos" className="btn-premium inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl bg-surface-base hover:bg-surface-subtle text-brand-navy border border-border-card text-base font-semibold shadow-sm hover:shadow-e2">
                <span>Conhecer soluções</span><ArrowRight className="w-4 h-4" />
              </a>
            </div>

            <div className="hero-enter grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-2xl" style={{ '--stagger': '440ms' } as React.CSSProperties}>
              <div className="flex items-center gap-2.5 rounded-xl border border-border-light bg-surface-base/80 px-3.5 py-3 text-xs sm:text-sm font-medium text-text-body shadow-xs card-premium card-glow-line hover:border-border-subtle"><CheckCircle2 className="w-4 h-4 text-emerald-600 shrink-0" /><span>Projeto pensado para seu negócio</span></div>
              <div className="flex items-center gap-2.5 rounded-xl border border-border-light bg-surface-base/80 px-3.5 py-3 text-xs sm:text-sm font-medium text-text-body shadow-xs card-premium card-glow-line hover:border-border-subtle"><Smartphone className="w-4 h-4 text-brand-blue shrink-0" /><span>Experiência responsiva</span></div>
              <div className="flex items-center gap-2.5 rounded-xl border border-border-light bg-surface-base/80 px-3.5 py-3 text-xs sm:text-sm font-medium text-text-body shadow-xs card-premium card-glow-line hover:border-border-subtle"><ShieldCheck className="w-4 h-4 text-brand-navy shrink-0" /><span>Suporte direto</span></div>
            </div>
          </div>

          <div className="lg:col-span-5 relative">
            <div className="hero-enter relative mx-auto max-w-md lg:max-w-none" style={{ '--stagger': '300ms' } as React.CSSProperties}>
              <div className="absolute -inset-4 rounded-[2rem] bg-brand-navy/5 blur-xl" aria-hidden="true" />
              <div className="relative rounded-3xl bg-surface-navy p-3 sm:p-4 shadow-2xl border border-brand-navy-light/40 ring-1 ring-white/5">
                <div className="absolute inset-x-12 top-0 h-px bg-gradient-to-r from-transparent via-brand-accent/35 to-transparent" aria-hidden="true" />
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-border-navy">
                  ...
                  <div className="px-3 py-1 rounded-md bg-white/10 text-[10px] sm:text-[11px] font-mono text-slate-200 border border-white/10">alair.info</div>
                ...
                <div className="card-premium absolute -bottom-5 -left-5 sm:-left-8 bg-surface-base border border-border-card rounded-2xl p-3.5 shadow-xl flex items-center gap-3 max-w-[250px]"><div className="w-10 h-10 rounded-xl bg-brand-navy/10 text-brand-navy flex items-center justify-center shrink-0"><ShieldCheck className="w-5 h-5" /></div><div><div className="text-xs font-bold text-brand-navy">Atendimento direto</div><div className="text-[11px] text-text-muted mt-0.5">Do primeiro contato à entrega</div></div></div>
              </div>
            </div>
          </div>
        </div>
